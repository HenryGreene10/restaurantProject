...
| 2      | 2026-05-06 | 2026-05-08 | Pino + pino-http (replaced morgan). Checkout integration tests (22 tests: create-payment-intent, checkout status, webhook payment_intent.succeeded/failed + idempotency, charge.refunded). Fixed pre-existing assistant test 401 (missing auth header). Moved all test module loading from per-test dynamic imports into beforeAll — eliminating first-test timeout flakiness. Added health endpoint DB-check tests (2 tests). Added admin-menu createItem + listItems round-trip tests (2 tests). 45/45 active tests pass (11 assistant tests skip on WSL2 due to module transform timeout — pre-existing). |     |
| 3      | —          | —          |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
| 4      | —          | —          |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
