...
const menuDefinition = [
  ...
  },
  {
    ...
    items: [
      item('Kung Pao', 21.5, {
        description:
          'Bell peppers, roasted peanuts, dried chili, serve with rice. (spicy level 3/10)',
        modifiers: [
          proteinModifier([
      ...
      item('Spicy Garlic Style', 19.95, {
        description:
          'Straw mushroom, water chestnut, wood ear mushroom, Garlic, ginger, chili, vinegar, scallion',
        modifiers: [
          proteinModifier([
      ...
      item('Toasted Rice Style', 20.95, {
        description:
          'Puffed crispy rice topped with vegetables in savory gravy — dramatic tableside preparation.',
        modifiers: [
          proteinModifier([
      ...
      item('Moo Shu', 19.95, {
        description:
          'Shredded cabbage, black fungus mushroom, eggs, Includes 4 crepes & plum sauce',
        modifiers: [
          proteinModifier([
  ...
  },
  {
    ...
    items: [
      item('Steamed Dishes', 19.95, {
        description:
          'Steamed in a bamboo steamer. Sauce on the side: Ginger Scallion / Spicy Garlic / Brown / House Special (mild spicy)',
        modifiers: [
          proteinModifier([
